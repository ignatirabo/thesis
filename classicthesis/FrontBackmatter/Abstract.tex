...
Utilizando \mtac podemos crear un nuevo meta-programa que cuasi automaticamente generalice la signatura de las funciones, permitiendo una comunicación fluida entre declaraciones monádicas. % seamless interaction/communication
