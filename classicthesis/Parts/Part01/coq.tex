...
En \ref{lst:sub_0_r}, definimos un lema enunciando que restar cero a cualquier número $n$ da como resultado $n$. Ya que la resta está definida por pattern matching en el primer argumento, esta igualdad no es automáticamente cierta computando. Por eso, debemos hacer análisis por casos.
