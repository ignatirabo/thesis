...
En la signatura de \lstinline{head} podemos ver el uso del $\Sigma$-tipo. En el caso de la lista vacía utilizamos \lstinline{!} para expresar que este caso es inalcazable en esta situación. De esta forma \lstinline{Program} genera la prueba correspondiente.
