...
% Un \lstinline{accessor} nos permite expresar el ``tener acceso'' a los valores para cada argumento del telescopio.
...
\begin{itemize}
  \item El \spacedlowsmallcaps{telescopio} \lstinline{m} que describe las dependencias a agregar.
  \item El \spacedlowsmallcaps{TyTree} \lstinline{T} con la signatura de la función.
  \item La \spacedlowsmallcaps{función} \lstinline{f : to_ty T}. La función a liftear.
\end{itemize}
...
% Esta funciona tiene solo tres casosa pero la principal diferencia es la signatura del retorno: es un $\sigma$-tipo que lleva una función \lstinline{F} y una prueba 
% \graffito{TODO: explicar uncurry}
