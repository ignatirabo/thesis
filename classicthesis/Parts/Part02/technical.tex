...
En este mostraremos en detalles las herramientas necesarias para la definición de \lift, la cual se hará en la sección \ref{sec:algoritmo}.
...
Ahora definiremos y analizaremos la función \lift.
