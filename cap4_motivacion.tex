...
El problema será que este solo soluciona el problema actual, y ante cualquier variación necesitaremos crear otro \coq{bind} más.

Es por eso que nuestro proyecto es la codificación de un nuevo meta-programa \coq{lift} que automaticamente puede generalizar meta-programas
